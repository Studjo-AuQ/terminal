...
(function () {
  ...
  /* ════════════════════════════════════════════════════
     0. ICON-PFAD ORDNERUNABHÄNGIG BERECHNEN
     Seiten liegen jetzt in unterschiedlichen Ordnertiefen
     (index.html im Hauptordner, Unterseiten in html/).
     Ein fest verdrahteter relativer Pfad würde je nach
     Seite falsch aufgelöst. Deshalb wird der Pfad relativ
     zum Speicherort DIESES Skripts (js/a11y.js) berechnet –
     das funktioniert dann von jeder Seite aus korrekt.
     ════════════════════════════════════════════════════ */
  const ICON_VORLESEN = new URL(
    '../symbole/zuhoeren.jpg',
  ...
  document.body.insertAdjacentHTML('beforeend', `
    ...
    <div class="a11y-bar" id="a11y-bar" role="toolbar" aria-label="Barrierefreiheit">
      ...
      <button class="a11y-btn" id="btn-vorlesen"
        ...
        <img src="${ICON_VORLESEN}" alt="Vorlesen">
      </button>
